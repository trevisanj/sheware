...
class table_deact_spectrum(table):
  ...
  def set_flag_inactive(self, flag_inactive, idspectrum, iddeact):
    ...
    # Before I was updating the table first and relying on the rowcount returned in the cursor to insert a record or not, but it seems the rowcount returned by mysql is sometimes zero even if
